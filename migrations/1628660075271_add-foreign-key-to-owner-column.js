...
exports.up = (pgm) => {
  // membuat user baru.
  pgm.sql("INSERT INTO users(id, username, password, fullname) VALUES ('old_note', 'old_notes', 'old_notes', 'old_notes')");
...
exports.down = (pgm) => {
  ...
  // mengubah nilai owner olde_notes pada note menjadi NULL
